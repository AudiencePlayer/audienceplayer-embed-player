export function binaryToBase64(a: any) {
    for (var b = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", c = [], d = 0; d < a.byteLength;) {
        ...
        c.push(b.charAt(e >> 2)),
            e = (3 & e) << 4,
            d < a.byteLength ? (c.push(b.charAt(e | a[d] >> 4)), e = (15 & a[d++]) << 2, d < a.byteLength ? (c.push(b.charAt(e | a[d] >> 6)), c.push(b.charAt(63 & a[d++]))) : (c.push(b.charAt(e)), c.push("="))) : (c.push(b.charAt(e)), c.push("=="))
    }
    return c.join("")
}

export function base64ToBinary(a: any) {
    for (var b = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", c = new Uint8Array(new ArrayBuffer(3 * a.length / 4 + 4)), d = 0, e = 0; d < a.length;) {
